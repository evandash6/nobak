    ...
    <div class="col-md-8" style="padding-left:30px">
        ...
        <div class="row m-t-20">
            <div class="col-md-4">
                ...
                <input type="text" name="telefono" class="form-control telefono" autocomplete="off" placeholder="Max 10 caracteres">
            </div>
            <div class="col-md-4">
                <label for="">Teléfono Celular:</label>
                <input type="text" name="celular" class="form-control telefono" autocomplete="off" placeholder="Max 10 caracteres">
            </div>
            <div class="col-md-4">
...
<div class="row m-t-20">
    <div class="col-md-12 text-right">
        ...
        <button type="submit" class="btn btn-primary waves-effect waves-themed"><i class="fa fa-save m-r-5"></i> Guardar Cambios</button>
    </div>
</div>
</form>
<script>
