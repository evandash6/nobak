...
<html lang="es">
    ...
    <aside class="page-sidebar"><div class="page-logo"> <img style="max-width:150px" src="<?=base_url()?>frontend/images/brillosos.png" class="img img-fluid" alt="Olimpoos WebApp">  </div><nav id="js-primary-nav" class="primary-nav" role="navigation"> <div class="nav-filter"> <div class="position-relative"> <input type="text" id="nav_filter_input" placeholder="Filter menu" class="form-control" tabindex="0"> <a href="#" onclick="return false;" class="btn-primary btn-search-close js-waves-off" data-action="toggle" data-class="list-filter-active" data-target=".page-sidebar"> <i class="fal fa-chevron-up"></i> </a> </div></div>
